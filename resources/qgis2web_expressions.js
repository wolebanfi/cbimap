...
function exp_Cbicountrieslistjoined_layer_2rule0_eval_expression(context) {
    // 
...
function exp_Cbicountrieslistjoined_layer_2rule1_eval_expression(context) {
    // country_name IS NOT NULL

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('country_name')  !== null);
    } else {
        return (feature.get('country_name')  !== null);
    }
}
...
function exp_SaintkittsandNevisVisafree_3rule0_eval_expression(context) {
    // Country IS NOT NULL

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Country')  !== null);
    } else {
        return (feature.get('Country')  !== null);
    }
}
...
function exp_MontenegroVisaFree_4rule0_eval_expression(context) {
    // Country IS NOT NULL
...
function exp_GrenadaVisaFree_5rule0_eval_expression(context) {
    // Country IS NOT NULL
...
function exp_StluciaVisaFree_6rule0_eval_expression(context) {
    // Country IS NOT NULL
