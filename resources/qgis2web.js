...
map.getView().fit([-14283373.847087, -4287853.067843, 18162799.045017, 12343163.985169], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_Cbicountrieslistjoined_layer_2,
    colName: 'residency_requirement_days',
    zoom: 10,
    collapsed: true,
    map: map
});
